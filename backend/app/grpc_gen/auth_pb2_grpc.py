...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Me = channel.unary_unary(
                '/library.auth.AuthService/Me',
                request_serializer=common__pb2.Empty.SerializeToString,
                response_deserializer=auth__pb2.CurrentUser.FromString,
                _registered_method=True)
        self.Logout = channel.unary_unary(
                '/library.auth.AuthService/Logout',
                request_serializer=common__pb2.Empty.SerializeToString,
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Me': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=auth__pb2.CurrentUser.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'library.auth.AuthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('library.auth.AuthService', rpc_method_handlers)
...
class AuthService(object):
    ...
    def Me(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            auth__pb2.CurrentUser.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
